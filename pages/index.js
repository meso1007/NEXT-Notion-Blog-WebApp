  ...
  return (
    <>
      <div className={styles.pageContainer}>
        <Head>
          <title>Notion Next.js Blog WEBAPP</title>
        ...
        <main className={styles.mainContainer}>
          <header className={styles.header}>
            ...
            <h1 className={styles.title}>Next.js + Notion API Blog</h1>
            ...
            {/* <p className={styles.subTitle}>This blog is integrated with Notion. Simply write in Notion, and it will be posted here directly.</p> */}
          </header>
